...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = SleepQualityViewModelFactory(sleepNightKey, sleepDataSource)
        ...
        viewModel.navigateBackToSleepTracker.observe(viewLifecycleOwner, Observer { doNavigation ->
            if (doNavigation) {
